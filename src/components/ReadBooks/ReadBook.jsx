    ...
    return (
        <div>
            ...
            <div className='p-[30px]'>
                <div className="lg:flex border border-gray-300 rounded-lg p-7 gap-10">
                    <div className='h-[250px] lg:pl-[80px] pt-4 rounded-2xl lg:w-[342px] bg-[#1313130D] '>
                    ...
                    <div>
                        <div className="ml-4 lg:mb-0 mb-5">
                            ...
                            <div className="lg:flex gap-5 text-center lg:items-center my-5">

                                <p><span className=' font-bold text-base'>Tag</span></p>

                                <div className='bg-[#23BE0A0D] text-[#23BE0A] w-[125px] font-bold h-[43px] text-center pt-2 rounded-full lg:my-0 my-5 '>#{tags[0]}</div>

                                <div className='bg-[#23BE0A0D] text-[#23BE0A] font-bold w-[125px] h-[43px] text-center pt-2 rounded-full '>#{tags[1]}</div>

                                <div className='flex gap-2 items-center lg:my-0 my-4'>
                                    <div className='text-xl'><CiLocationOn /></div>
                                    <p className=''>Year of Publishing : {yearOfPublishing}</p>
                                </div>
                            </div>

                            <div className='lg:flex gap-14 mb-4'>
                                <div className='flex items-center lg:mb-0 mb-3 gap-2'>
                            ...
                            <div className="lg:flex gap-5 text-center items-center my-5">
                                <div className='bg-[#328EFF26] text-[#328EFF] w-[165px] font-bold h-[43px] text-center pt-2 rounded-full '>Category : {category}</div>

                                <div className='bg-[#23BE0A0D] text-[#23BE0A] font-bold w-[125px] h-[43px] text-center pt-2 rounded-full lg:my-0 my-5'>Rating : {rating}</div>
                                <div>
